...
(function() {
  angular.module('app').controller('LoginController', function($scope, $http, NotifierService, IdentityService, AuthService, $location, $dialogs, FeedbackMessage, CachedCourse) {
    ...
    return $scope.openFeedbackModal = function() {
