...
(function() {
  angular.module('app').factory('CachedRating', function(RatingModel, $q) {
    var CachedRating, ratingList;
    ratingList = {};
    CachedRating = (function() {
      function CachedRating() {}

      CachedRating.prototype.query = function(args) {
        var _name;
      ...
      CachedRating.prototype.findOne = function(args) {
        var $d;
        $d = $q.defer();
      ...
      CachedRating.prototype.create = function(args) {
        var $d, newRating;
        $d = $q.defer();
