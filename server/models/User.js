...
(function() {
  var Mixed, User, createDefaultUsers, mongoose, security, userSchema,
  ...
  userSchema.methods = {
    ...
    getData: function() {
      var allMessages, courses, firstName, lastName, roles, unreadMessages, username;
      firstName = this.firstName, lastName = this.lastName, username = this.username, roles = this.roles, unreadMessages = this.unreadMessages, allMessages = this.allMessages, courses = this.courses;
      return {
        firstName: firstName,
        lastName: lastName,
        username: username,
